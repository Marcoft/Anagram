...
public class VegetablesActivityTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vegetables_test);
    ...
    public void changeWord() {
        ...
        if(dictionary[0].equalsIgnoreCase("лук")){
            imgPicture.setImageResource(R.drawable.luk);
        } else  if(dictionary[0].equalsIgnoreCase("горох")){
            imgPicture.setImageResource(R.drawable.goroh);
        }else  if(dictionary[0].equalsIgnoreCase("тыква")){
            imgPicture.setImageResource(R.drawable.tikva);
        }else  if(dictionary[0].equalsIgnoreCase("перец")){
            imgPicture.setImageResource(R.drawable.perec);
        }else  if(dictionary[0].equalsIgnoreCase("чеснок")){
            imgPicture.setImageResource(R.drawable.chesnok);
        }else  if(dictionary[0].equalsIgnoreCase("свекла")){
            imgPicture.setImageResource(R.drawable.svekla);
        }else  if(dictionary[0].equalsIgnoreCase("огурец")){
            imgPicture.setImageResource(R.drawable.ogurec);
        }else  if(dictionary[0].equalsIgnoreCase("спаржа")){
            imgPicture.setImageResource(R.drawable.sparsha);
        }else  if(dictionary[0].equalsIgnoreCase("морковь")){
            imgPicture.setImageResource(R.drawable.morkov);
        }else  if(dictionary[0].equalsIgnoreCase("базилик")){
            imgPicture.setImageResource(R.drawable.basilik);
        }else  if(dictionary[0].equalsIgnoreCase("помидор")){
            imgPicture.setImageResource(R.drawable.pomidor);
        }else  if(dictionary[0].equalsIgnoreCase("кукуруза")){
            imgPicture.setImageResource(R.drawable.kukuruza);
        }else  if(dictionary[0].equalsIgnoreCase("брокколи")){
            imgPicture.setImageResource(R.drawable.brokkoli);
        }else  if(dictionary[0].equalsIgnoreCase("баклажан")){
            imgPicture.setImageResource(R.drawable.baklashan);
        }else  if(dictionary[0].equalsIgnoreCase("картофель")){
            imgPicture.setImageResource(R.drawable.kartoshka);
        }
    }
    ...
    private void InsertWord(){
        if(dictionary[0].equalsIgnoreCase("лук")) {
            InsetAlg("а","р","л","в","и","б","й","ф","х","у","р","к","и","о");
        } else  if(dictionary[0].equalsIgnoreCase("горох")) {
            InsetAlg("х","г","р","и","ц","м","а","о","о","е","л","ш","к","ю");
        } else  if(dictionary[0].equalsIgnoreCase("тыква")) {
            InsetAlg("к","т","и","н","ы","б","м","к","й","г","в","з","а","о");
        }else  if(dictionary[0].equalsIgnoreCase("перец")) {
            InsetAlg("в","ц","п","а","н","е","л","и","т","ш","е","х","ч","р");
        }else  if(dictionary[0].equalsIgnoreCase("чеснок")) {
            InsetAlg("ж","е","с","й","н","у","о","а","р","п","ч","т","к","э");
        }else  if(dictionary[0].equalsIgnoreCase("свекла")) {
            InsetAlg("р","и","ф","е","о","а","с","т","ю","л","к","т","в","ч");
        }else  if(dictionary[0].equalsIgnoreCase("огурец")) {
            InsetAlg("г","у","п","а","в","о","е","х","р","й","з","т","м","ц");
        }else  if(dictionary[0].equalsIgnoreCase("спаржа")) {
            InsetAlg("ы","с","п","я","л","а","в","р","к","а","ц","ч","ж","б");
        }else  if(dictionary[0].equalsIgnoreCase("морковь")) {
            InsetAlg("о","и","м","с","я","ь","к","о","в","р","л","в","б","п");
        }else  if(dictionary[0].equalsIgnoreCase("базилик")) {
            InsetAlg("к","и","и","ц","ч","л","а","г","з","н","а","ы","б","о");
        }else  if(dictionary[0].equalsIgnoreCase("помидор")) {
            InsetAlg("у","м","п","и","р","ф","ь","я","к","о","а","д","н","ж");
        }else  if(dictionary[0].equalsIgnoreCase("кукуруза")) {
            InsetAlg("ы","к","у","е","х","р","з","н","у","у","л","к","в","а");
        }else  if(dictionary[0].equalsIgnoreCase("брокколи")) {
            InsetAlg("ж","ц","е","к","л","ь","к","о","и","б","н","а","р","о");
        }else  if(dictionary[0].equalsIgnoreCase("баклажан")) {
            InsetAlg("м","л","е","а","б","х","с","а","н","у","к","а","ж","и");
        }else  if(dictionary[0].equalsIgnoreCase("картофель")) {
            InsetAlg("л","р","н","т","а","у","б","о","п","к","ь","е","и","ф");
        }
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        hintsAlgorithm.showDefinition(VegetablesActivityTest.this,Money_text,dictionary);
                        break;
                }
            }
        });
    ...
    public void openLetter() {
        ...
        if(money_for_open_word >= 15 ){     //((dictionary[0].length()*20* 30* 1.5)/100)) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(VegetablesActivityTest.this);
