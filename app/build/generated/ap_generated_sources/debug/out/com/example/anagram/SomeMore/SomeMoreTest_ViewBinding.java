...
public class SomeMoreTest_ViewBinding implements Unbinder {
  private SomeMoreTest target;

  @UiThread
  public SomeMoreTest_ViewBinding(SomeMoreTest target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SomeMoreTest_ViewBinding(SomeMoreTest target, View source) {
    this.target = target;

    target.OpenWordMoreTest = Utils.findRequiredViewAsType(source, R.id.OpenWordMoreTest, "field 'OpenWordMoreTest'", Button.class);
    ...
    target.edt15 = Utils.findRequiredViewAsType(source, R.id.edt15, "field 'edt15'", EditText.class);
    target.edt16 = Utils.findRequiredViewAsType(source, R.id.edt16, "field 'edt16'", EditText.class);
    target.edt17 = Utils.findRequiredViewAsType(source, R.id.edt17, "field 'edt17'", EditText.class);
    target.edt18 = Utils.findRequiredViewAsType(source, R.id.edt18, "field 'edt18'", EditText.class);
    target.edt19 = Utils.findRequiredViewAsType(source, R.id.edt19, "field 'edt19'", EditText.class);
    target.edt20 = Utils.findRequiredViewAsType(source, R.id.edt20, "field 'edt20'", EditText.class);
    target.edt21 = Utils.findRequiredViewAsType(source, R.id.edt21, "field 'edt21'", EditText.class);
    target.edt22 = Utils.findRequiredViewAsType(source, R.id.edt22, "field 'edt22'", EditText.class);
    target.edt23 = Utils.findRequiredViewAsType(source, R.id.edt23, "field 'edt23'", EditText.class);
    target.edt24 = Utils.findRequiredViewAsType(source, R.id.edt24, "field 'edt24'", EditText.class);
    target.edt25 = Utils.findRequiredViewAsType(source, R.id.edt25, "field 'edt25'", EditText.class);
  ...
  @CallSuper
  public void unbind() {
    SomeMoreTest target = this.target;
    if (target == null) throw new IllegalStateException("Bindings already cleared.");
    this.target = null;

    target.OpenWordMoreTest = null;
    target.text = null;
