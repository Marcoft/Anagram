...
public class RiddleTest_ViewBinding implements Unbinder {
  private RiddleTest target;

  @UiThread
  public RiddleTest_ViewBinding(RiddleTest target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public RiddleTest_ViewBinding(RiddleTest target, View source) {
    this.target = target;
    ...
    target.check_riddle_test = Utils.findRequiredViewAsType(source, R.id.check_riddle_test, "field 'check_riddle_test'", Button.class);
    target.text_riddle_test = Utils.findRequiredViewAsType(source, R.id.text_riddle_test, "field 'text_riddle_test'", TextView.class);
  ...
  public void unbind() {
    ...
    target.edt13 = null;
    target.edt14 = null;
    target.check_riddle_test = null;
    target.text_riddle_test = null;
