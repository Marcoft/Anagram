...
public class VegetablesActivityTest_ViewBinding implements Unbinder {
  private VegetablesActivityTest target;

  @UiThread
  public VegetablesActivityTest_ViewBinding(VegetablesActivityTest target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public VegetablesActivityTest_ViewBinding(VegetablesActivityTest target, View source) {
    this.target = target;
    ...
    target.imgPicture = Utils.findRequiredViewAsType(source, R.id.imgPicture, "field 'imgPicture'", ImageButton.class);
  ...
  @CallSuper
  public void unbind() {
    VegetablesActivityTest target = this.target;
