...
public class FruitsActivityTest_ViewBinding implements Unbinder {
  private FruitsActivityTest target;

  @UiThread
  public FruitsActivityTest_ViewBinding(FruitsActivityTest target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public FruitsActivityTest_ViewBinding(FruitsActivityTest target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FruitsActivityTest target = this.target;
